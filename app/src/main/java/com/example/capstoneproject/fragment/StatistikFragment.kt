...
class StatistikFragment : Fragment() {
    private lateinit var binding: StatistikFragmentBinding
    ...
    override fun onCreateView(
        ...
        val fragmentBinding = StatistikFragmentBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.statistikFragment = this
    ...
    private fun updateRecyclerViewAdapters(isUpdateAll : Boolean, position: Int = 0){
        penganggeLists.forEachIndexed {index, list ->
            ...
            recyclerView[index].adapter = StatistikAdapter(requireContext(), updateToAdapter)
        }
    }
    ...
    private fun processLatihanData(dataSnapshot: DataSnapshot){
        ...
        for(tanggalSnapshot in dataSnapshot.children){
            ...
            hurufBenar[tanggalSnapshot.key?.substring(8, 10)] = huruf_benar
            if (huruf_benar != null) {
    ...
    private fun createChar(hurufBenar : Map<String?, Int?>){
...
//            valueFormatter = IndexAxisValueFormatter(indexEntries)
            granularity = 1f
            textSize = 12f
            axisLineWidth = 3f
            axisLineColor = Color.BLACK
